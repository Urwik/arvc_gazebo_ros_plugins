...
namespace gazebo
{
  class TestDatasetGenerator : public WorldPlugin
  {
  ...
  private:
    ...
    /// @brief Check the collision between the sensor and the structure models
    bool checkSensorCollisionWithStructure();
  ...
  private:
    ...
    physics::ModelPtr structure_model;
